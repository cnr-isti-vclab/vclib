...
function(_vclib_add_test_example name)
    ...
    if(WIN32)
        set(COPY_DLLS_SCRIPT "${CMAKE_CURRENT_BINARY_DIR}/copy_dlls_${TARGET_NAME}.cmake")
        file(GENERATE OUTPUT "${COPY_DLLS_SCRIPT}" CONTENT "
...
")
    ...
    if(${ARG_TEST})
        ...
        if(NOT ${TO_EXCLUDE})
            enable_testing()
            if(${ARG_TEST})
                include(Catch OPTIONAL RESULT_VARIABLE CATCH_INCLUDED)
                if(CATCH_INCLUDED AND COMMAND catch_discover_tests)
