...
class PolyLinesComboBox : public QComboBox
{
public:
    PolyLinesComboBox(QWidget* parent = nullptr) : QComboBox(parent)
    {
        addItem("CPUGeneratedPolyLines");
        addItem("GPUGeneratedPolyLines");
        addItem("InstancingBasedPolyLines");
        addItem("IndirectBasedPolyLines");
        addItem("TextureBasedPolyLines");
    }
};
...
int main(int argc, char** argv)
{
    ...
    PolyLinesComboBox* cb = new PolyLinesComboBox(&w);
    layout->addWidget(cb);
