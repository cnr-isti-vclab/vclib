...
int main(int argc, char** argv)
{
    using ImGuiDemo = vcl::RenderApp<
        ...
        vcl::Canvas,
        PolylinesImGuiDrawer,
        vcl::TrackBallViewerDrawer>;

    ImGuiDemo tw("Test Polylines ImGui GLFW");
