...
#ifndef COPY_AND_TRASNFORM_H
#define COPY_AND_TRASNFORM_H
...
auto meshCopyAndTransform()
{
    ...
    transformMesh.name() = "Transformed Icosahedron";
    ...
    return std::make_tuple(
        transformMesh, scaleMesh, rotateMesh, matrixMesh, combinedMesh);
}

#endif // COPY_AND_TRASNFORM_H
