...
#ifndef MGP_MESH_COMPONENTS_VECTOR_OPTIONAL_MUTABLE_BIT_FLAGS_VECTOR_H
#define MGP_MESH_COMPONENTS_VECTOR_OPTIONAL_MUTABLE_BIT_FLAGS_VECTOR_H
...
#endif // MGP_MESH_COMPONENTS_VECTOR_OPTIONAL_MUTABLE_BIT_FLAGS_VECTOR_H
