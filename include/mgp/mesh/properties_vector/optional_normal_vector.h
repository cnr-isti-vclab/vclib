...
#ifndef MGP_MESH_PROPERTIES_VECTOR_OPTIONAL_NORMAL_VECTOR_H
#define MGP_MESH_PROPERTIES_VECTOR_OPTIONAL_NORMAL_VECTOR_H

#include <mgp/mesh/properties_optional/optional_normal.h>
...
template<typename T>
class OptionalNormalVector<T, std::enable_if_t<prop::hasOptionalNormal<T>()>> :
...
#endif // MGP_MESH_PROPERTIES_VECTOR_OPTIONAL_NORMAL_VECTOR_H
