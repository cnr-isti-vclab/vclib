...
#ifndef MGP_MESH_PROPERTIES_VECTOR_OPTIONAL_MUTABLE_BIT_FLAGS_VECTOR_H
#define MGP_MESH_PROPERTIES_VECTOR_OPTIONAL_MUTABLE_BIT_FLAGS_VECTOR_H

#include <mgp/mesh/properties_optional/optional_mutable_bit_flags.h>
...
class OptionalMutableBitFlagsVector<
	T,
	std::enable_if_t<prop::hasOptionalMutableBitFlags<T>()>> :
...
#endif // MGP_MESH_PROPERTIES_VECTOR_OPTIONAL_MUTABLE_BIT_FLAGS_VECTOR_H
