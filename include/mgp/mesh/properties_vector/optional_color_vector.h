...
#ifndef MGP_MESH_PROPERTIES_VECTOR_OPTIONAL_COLOR_VECTOR_H
#define MGP_MESH_PROPERTIES_VECTOR_OPTIONAL_COLOR_VECTOR_H

#include <mgp/mesh/properties_optional/optional_color.h>
...
template<typename T>
class OptionalColorVector<T, std::enable_if_t<prop::hasOptionalColor<T>()>> :
...
#endif // MGP_MESH_PROPERTIES_VECTOR_OPTIONAL_COLOR_VECTOR_H
