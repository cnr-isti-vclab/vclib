...
#ifndef MGP_MESH_PROPERTIES_OPTIONAL_VERTEX_REFERENCES_H
#define MGP_MESH_PROPERTIES_OPTIONAL_VERTEX_REFERENCES_H
...
#endif // MGP_MESH_PROPERTIES_OPTIONAL_VERTEX_REFERENCES_H
