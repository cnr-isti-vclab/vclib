...
/**
 * @brief HasFaces concepts is satisfied when at least one of its template types is (or inherits
 * from) a FaceContainer. It can be used both to check if a Mesh has faces, or if in a list of types
