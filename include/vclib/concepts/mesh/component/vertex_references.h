...
#ifndef VCL_CONCEPTS_MESH_COMPONENT_VERTEX_REFERENCES_H
#define VCL_CONCEPTS_MESH_COMPONENT_VERTEX_REFERENCES_H
...
#endif // VCL_CONCEPTS_MESH_COMPONENT_VERTEX_REFERENCES_H
