...
#ifndef VCL_CONCEPTS_MESH_COMPONENT_PRINCIPAL_CURVATURE_H
#define VCL_CONCEPTS_MESH_COMPONENT_PRINCIPAL_CURVATURE_H
...
#endif // VCL_CONCEPTS_MESH_COMPONENT_PRINCIPAL_CURVATURE_H
