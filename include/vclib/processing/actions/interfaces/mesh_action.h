...
public:
     ...
     *
     * Return 0 if the action does not require input meshes;
     * Return vcl::UINT_NULL if the number of input meshes is not known.
     *
     ...
     *
     * Return 0 if the action does not generate output meshes;
     * Return vcl::UINT_NULL if the number of output meshes is not known.
     *
