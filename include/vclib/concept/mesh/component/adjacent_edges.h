...
#ifndef VCL_CONCEPT_MESH_COMPONENT_ADJACENT_EDGES_H
#define VCL_CONCEPT_MESH_COMPONENT_ADJACENT_EDGES_H
	...
	std::vector<typename T::AdjacentEdgeType*> v)
{
	...
	typename T::AdjacentEdgeRange;
	typename T::ConstAdjacentEdgeRange;
	...
	{ o.adjEdges() } -> std::same_as<typename T::AdjacentEdgeRange>;
	{ co.adjEdges() } -> std::same_as<typename T::ConstAdjacentEdgeRange>;
};
...
#endif // VCL_CONCEPT_MESH_COMPONENT_ADJACENT_EDGES_H
