...
#ifndef VCL_CONCEPT_MESH_COMPONENT_PRINCIPAL_CURVATURE_H
#define VCL_CONCEPT_MESH_COMPONENT_PRINCIPAL_CURVATURE_H
...
#endif // VCL_CONCEPT_MESH_COMPONENT_PRINCIPAL_CURVATURE_H
