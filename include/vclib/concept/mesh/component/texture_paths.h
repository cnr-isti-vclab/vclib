...
#ifndef VCL_CONCEPT_MESH_COMPONENT_TEXTURE_PATHS_H
#define VCL_CONCEPT_MESH_COMPONENT_TEXTURE_PATHS_H
	...
	std::string s)
{
	...
	typename T::TexFileNamesRange;
	typename T::ConstTexFileNamesRange;
	...
	{ o.texturePaths() } -> std::same_as<typename T::TexFileNamesRange>;
	{ co.texturePaths() } -> std::same_as<typename T::ConstTexFileNamesRange>;
};

} // namespace vcl::comp

#endif // VCL_CONCEPT_MESH_COMPONENT_TEXTURE_PATHS_H
