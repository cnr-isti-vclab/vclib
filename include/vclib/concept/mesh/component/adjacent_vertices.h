...
#ifndef VCL_CONCEPT_MESH_COMPONENT_ADJACENT_VERTICES_H
#define VCL_CONCEPT_MESH_COMPONENT_ADJACENT_VERTICES_H
...
#endif // VCL_CONCEPT_MESH_COMPONENT_ADJACENT_VERTICES_H
