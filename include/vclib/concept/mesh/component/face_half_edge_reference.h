...
#ifndef VCL_CONCEPT_MESH_COMPONENT_FACE_HALF_EDGE_REFERENCE_H
#define VCL_CONCEPT_MESH_COMPONENT_FACE_HALF_EDGE_REFERENCE_H
...
#endif // VCL_CONCEPT_MESH_COMPONENT_FACE_HALF_EDGE_REFERENCE_H
