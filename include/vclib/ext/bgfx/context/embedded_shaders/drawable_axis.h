...
#ifndef VCL_EXT_BGFX_CONTEXT_EMBEDDED_SHADERS_DRAWABLE_AXIS_H
#define VCL_EXT_BGFX_CONTEXT_EMBEDDED_SHADERS_DRAWABLE_AXIS_H
...
#endif // VCL_EXT_BGFX_CONTEXT_EMBEDDED_SHADERS_DRAWABLE_AXIS_H
