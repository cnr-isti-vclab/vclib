...
#ifndef VCL_EXT_QT_GUI_TEXT_EDIT_LOGGER_ERROR_IO_DEVICE_H
#define VCL_EXT_QT_GUI_TEXT_EDIT_LOGGER_ERROR_IO_DEVICE_H
...
#endif // VCL_EXT_QT_GUI_TEXT_EDIT_LOGGER_ERROR_IO_DEVICE_H
