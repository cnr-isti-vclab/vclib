...
#ifndef VCL_EXT_QT_GUI_MESH_RENDER_SETTINGS_FRAME_POINTS_FRAME_H
#define VCL_EXT_QT_GUI_MESH_RENDER_SETTINGS_FRAME_POINTS_FRAME_H
...
#endif // VCL_EXT_QT_GUI_MESH_RENDER_SETTINGS_FRAME_POINTS_FRAME_H
