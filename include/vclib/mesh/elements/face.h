...
public:
	...
	using VertexCoordIterator = VertexPointerCoordIterator<typename VRefs::VertexIterator>;
	using ConstVertexCoordIterator = VertexPointerCoordIterator<typename VRefs::ConstVertexIterator>;
