...
/**
 * @brief The ContainerComponent class is the base class for all the components of VCLib that store
 * a container of objects of a given type T.
 *
 * A component that inherits from this class will have all the features of the @ref Component class,
 * plus automatic storage of the data in a Container of objects that could have static or dynamic
 * size, and the possibility to tie the size of the Container to the number of Vertices of the
 * Element (E.g. useful for some Face components like AdjacentFaces or WedgeTexCoords).
 *
 ...
 * If you don't have additional data. set AdditionalData = void. E.g. a WedgeTexCoord component
 * stores a short as AdditionalData that indicates the texture index used by all the Wedge
 * TexCoords.
 ...
 * number and changed automatically when the number of vertices changes. E.g. a WedgeTexCoord
 * component is a Container that should be tied to the vertex number, meaning that the number of
 * texture coordinates should be always be the same of the number of vertices. Setting this value to
 * true will tie the size of this container to the number of vertices.
