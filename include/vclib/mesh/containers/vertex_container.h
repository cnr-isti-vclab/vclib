...
public:
     ...
     * contains **const references** to the custom component, therefore you can
     * access to the custom component by accessing the element of the handle
     * vector normally. Since the handle stores references, there are no copies
