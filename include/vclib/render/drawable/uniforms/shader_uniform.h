...
#ifndef VCL_RENDER_DRAWABLE_UNIFORMS_SHADER_UNIFORM_H
#define VCL_RENDER_DRAWABLE_UNIFORMS_SHADER_UNIFORM_H
...
#endif // VCL_RENDER_DRAWABLE_UNIFORMS_SHADER_UNIFORM_H
