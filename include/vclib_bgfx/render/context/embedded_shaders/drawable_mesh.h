...
#ifndef VCL_BGFX_RENDER_CONTEXT_EMBEDDED_SHADERS_DRAWABLE_MESH_H
#define VCL_BGFX_RENDER_CONTEXT_EMBEDDED_SHADERS_DRAWABLE_MESH_H
...
#endif // VCL_BGFX_RENDER_CONTEXT_EMBEDDED_SHADERS_DRAWABLE_MESH_H
