...
/**
 * @brief The %EL_UC%RangeConcept evaluates to true if Rng is a valid Range on %EL_UC%s.
 *
 * This means that Rng must be a Range of %EL_UC%Concept: the iterated type must satisfy the
 * %EL_UC%Concept.
 *
...
/**
 * @brief The %EL_UC%PointerRangeConcept evaluates to true if Rng is a valid Range on %EL_UC%
 * Pointers.
 *
 * This means that Rng must be a Range of pointers to a type that satisfy the %EL_UC%Concept.
 *
 * @ingroup %EL%_concepts
 */
template<typename Rng>
