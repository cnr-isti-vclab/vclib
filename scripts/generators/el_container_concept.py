...
def generate_elem_container_concept(element):
    ...
    with open("../include/vclib/concepts/mesh/containers/" + element.name + '_container.h', 'w') as file:
        file.write(element_container_concept)

    print("Generated Element Concepts: include/vclib/concepts/mesh/containers/" + element.name + '_container.h')