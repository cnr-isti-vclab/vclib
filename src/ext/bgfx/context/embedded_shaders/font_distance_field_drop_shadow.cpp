...
#include <shaders/vclib/ext/bgfx/font/fs_font_distance_field_drop_shadow.sc.140.bin.h>
#include <shaders/vclib/ext/bgfx/font/vs_font_distance_field_drop_shadow.sc.140.bin.h>
#include <shaders/vclib/ext/bgfx/font/fs_font_distance_field_drop_shadow.sc.320_es.bin.h>
#include <shaders/vclib/ext/bgfx/font/vs_font_distance_field_drop_shadow.sc.320_es.bin.h>
    ...
    vertexEmbeddedShader(bgfx::RendererType::Enum type)
{
    ...
    case bgfx::RendererType::OpenGLES:
        return {type, vs_font_distance_field_drop_shadow_320_es, sizeof(vs_font_distance_field_drop_shadow_320_es)};
    case bgfx::RendererType::OpenGL:
        return {type, vs_font_distance_field_drop_shadow_140, sizeof(vs_font_distance_field_drop_shadow_140)};
    ...
    fragmentEmbeddedShader(bgfx::RendererType::Enum type)
{
    switch (type) {
    case bgfx::RendererType::OpenGLES:
        return {type, fs_font_distance_field_drop_shadow_320_es, sizeof(fs_font_distance_field_drop_shadow_320_es)};
    case bgfx::RendererType::OpenGL:
        return {type, fs_font_distance_field_drop_shadow_140, sizeof(fs_font_distance_field_drop_shadow_140)};
    case bgfx::RendererType::Vulkan:
