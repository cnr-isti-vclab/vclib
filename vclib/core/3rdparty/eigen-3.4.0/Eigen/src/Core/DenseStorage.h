...
public:
    ...
    {
        internal::plain_array_helper::copy(
            other.m_data, m_rows * m_cols, m_data);
    }
...
public:
    ...
    {
        internal::plain_array_helper::copy(
            other.m_data, m_rows * _Cols, m_data);
    }
...
public:
    ...
    {
        internal::plain_array_helper::copy(
            other.m_data, _Rows * m_cols, m_data);
    }
...
public:
    ...
    {
        internal::
            conditional_aligned_delete_auto<T, (_Options & DontAlign) == 0>(
...
public:
            ...
            m_cols(other.m_cols)
    {
        ...
        internal::smart_copy(
            other.m_data, other.m_data + _Rows * m_cols, m_data);
    }
...
public:
            ...
            m_rows(other.m_rows)
    {
        ...
        internal::smart_copy(
            other.m_data, other.m_data + other.m_rows * _Cols, m_data);
    }
