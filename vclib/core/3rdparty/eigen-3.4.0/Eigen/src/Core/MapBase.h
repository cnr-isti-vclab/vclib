...
public:
    ...
    inline MapBase(PointerType dataPtr, Index vecSize) :
            m_data(dataPtr),
            m_rows(
                RowsAtCompileTime == Dynamic ? vecSize :
                                               Index(RowsAtCompileTime)),
            m_cols(
                ColsAtCompileTime == Dynamic ? vecSize :
...
public:
    ...
    EIGEN_DEVICE_FUNC inline MapBase(
        PointerType dataPtr,
        Index       rows,
        Index       cols) :
