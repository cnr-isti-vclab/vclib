...
public:
    ...
    EIGEN_DEVICE_FUNC inline const CoeffReturnType coeff(Index row, Index col)
        const
    {
    ...
    {
        m_expression.const_cast_derived().template writePacket<Aligned>(
            row, col, x);
    }
...
inline const ForceAlignedAccess<Derived> MatrixBase<
...
inline typename internal::add_const_on_value_type<
    typename internal::
        conditional<Enable, ForceAlignedAccess<Derived>, Derived&>::type>::type
