...
struct pselect_impl
{
    static EIGEN_DEVICE_FUNC inline Packet run(
        const Packet& mask,
        const Packet& a,
        const Packet& b)
    {
...
template<typename Packet>
EIGEN_DEVICE_FUNC inline Packet pselect(
    const Packet& mask,
    const Packet& a,
    const Packet& b)
{
...
EIGEN_DEVICE_FUNC inline
    typename enable_if<unpacket_traits<Packet>::masked_load_available, Packet>::
        type
        ploadu(
            const typename unpacket_traits<Packet>::type* from,
...
template<typename Scalar, typename Packet>
EIGEN_DEVICE_FUNC inline
    typename enable_if<unpacket_traits<Packet>::masked_store_available, void>::
        type
        pstoreu(
            Scalar*                                  to,
            const Packet&                            from,
...
EIGEN_DEVICE_FUNC inline typename conditional<
    (unpacket_traits<Packet>::size % 8) == 0,
...
template<typename Packet>
EIGEN_DEVICE_FUNC inline Packet pmadd(
    const Packet& a,
    const Packet& b,
    const Packet& c)
{
