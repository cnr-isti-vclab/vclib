...
{
    return vcombine_s16(
        vmovn_s32(vcvtq_s32_f32(a)), vmovn_s32(vcvtq_s32_f32(b)));
}
...
{
    return vcombine_u16(
        vmovn_u32(vcvtq_u32_f32(a)), vmovn_u32(vcvtq_u32_f32(b)));
}
...
{
    return vcombine_u8(
        vmovn_u16(vreinterpretq_u16_s16(a)),
...
{
    return vcombine_u16(
        vmovn_u32(vreinterpretq_u32_s32(a)),
...
{
    return vcombine_s32(
        vmovn_s64(vcvtq_s64_f64(a)), vmovn_s64(vcvtq_s64_f64(b)));
}
...
{
    return vcombine_u32(
        vmovn_u64(vcvtq_u64_f64(a)), vmovn_u64(vcvtq_u64_f64(b)));
}
