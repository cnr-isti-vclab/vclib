...
template<typename T>
struct add_const_on_value_type<const T* const>
{
    typedef const T* const type;
};
...
struct array_size<
    T,
    typename internal::enable_if<((T::SizeAtCompileTime & 0) == 0)>::type>
{
...
struct result_of<Func()>
{
    ...
    static has_std_result_type testFunctor(
        const T*,
        typename const T::result_type* = 0);
    template<typename T>
    static has_tr1_result testFunctor(
        const T*,
        typename T::template const result<T()>::type* = 0);
...
struct result_of<Func(ArgType)>
{
    ...
    static has_tr1_result testFunctor(
        const T*,
        typename T::template const result<T(ArgType)>::type* = 0);
    static has_none testFunctor(...);
...
struct result_of<Func(ArgType0, ArgType1)>
{
    ...
    static has_tr1_result testFunctor(
        const T*,
        typename T::template const result<T(ArgType0, ArgType1)>::type* = 0);
    static has_none testFunctor(...);

    // note that the following indirection is needed for gcc-3.3
    enum { FunctorType = sizeof(testFunctor(static_cast<Func*>(0))) };

    typedef typename binary_result_of_select<
        Func,
        ArgType0,
        ArgType1,
...
struct result_of<Func(ArgType0, ArgType1, ArgType2)>
{
    ...
    static has_tr1_result testFunctor(
        const T*,
        typename T::template const result<
            T(ArgType0, ArgType1, ArgType2)>::type* = 0);
    static has_none testFunctor(...);
...
template<
    typename F,
    typename ArgType0 = void,
    typename ArgType1 = void,
...
struct has_binary_operator
{
    ...
    static meta_yes testFunctor(
        const C*,
        typename enable_if<
            (sizeof(return_ptr<C>()->operator()(IndexType(0), IndexType(0))) >
             0)>::type* = 0);
    static meta_no testFunctor(...);
