...
public:
    ...
    {
        eigen_assert(int(Direction) == Vertical);
        return Product<Transform<Scalar, Dim, Mode, Options>, Homogeneous>(
            lhs, rhs);
    }
...
EIGEN_DEVICE_FUNC inline Homogeneous<ExpressionType, Direction> VectorwiseOp<
    ExpressionType,
...
struct homogeneous_left_product_impl<Homogeneous<MatrixType, Vertical>, Lhs> :
        public ReturnByValue<homogeneous_left_product_impl<
            Homogeneous<MatrixType, Vertical>,
            Lhs>>
{
    ...
    EIGEN_DEVICE_FUNC homogeneous_left_product_impl(
        const Lhs&        lhs,
...
template<typename MatrixType, typename Rhs>
struct homogeneous_right_product_impl<
    Homogeneous<MatrixType, Horizontal>,
    Rhs> :
            ...
            Rhs>>
{
    ...
    EIGEN_DEVICE_FUNC homogeneous_right_product_impl(
...
struct product_evaluator<
    ...
    HomogeneousShape> :
        public evaluator<typename homogeneous_left_product_refactoring_helper<
            Lhs,
            typename Rhs::NestedExpression>::Xpr>
{
    typedef Product<Lhs, Rhs, LazyProduct> XprType;
    typedef homogeneous_left_product_refactoring_helper<
        Lhs,
        typename Rhs::NestedExpression>
                                           helper;
    typedef typename helper::ConstantBlock ConstantBlock;
    typedef typename helper::Xpr           RefactoredXpr;
    typedef evaluator<RefactoredXpr>       Base;
...
struct permutation_matrix_product<
    ...
    Transposed,
    HomogeneousShape> :
        public permutation_matrix_product<
            ExpressionType,
            Side,
            Transposed,
            DenseShape>
