...
EIGEN_DEVICE_FUNC
EIGEN_STRONG_INLINE const CwiseBinaryOp<
    internal::scalar_absolute_difference_op<Scalar, Scalar>,
    const Derived,
    const CwiseNullaryOp<internal::scalar_constant_op<Scalar>, PlainObject>>
#ifdef EIGEN_PARSED_BY_DOXYGEN
absolute_difference
...
friend const CwiseBinaryOp<
    internal::scalar_sum_op<T, Scalar>,
    Constant<T>,
    Derived>
...
template<typename T>
const CwiseBinaryOp<
    internal::scalar_difference_op<Scalar, T>,
    Derived,
    Constant<T>>
operator-(const T& scalar) const;
...
template<typename T>
friend const CwiseBinaryOp<
    internal::scalar_difference_op<T, Scalar>,
    Constant<T>,
    Derived>
operator-(const T& scalar, const StorageBaseType& expr);
#endif
...
friend inline const CwiseBinaryOp<
    internal::scalar_quotient_op<T, Scalar>,
    Constant<T>,
    Derived>
