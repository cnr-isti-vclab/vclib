...
public:
    ...
    explicit CompleteOrthogonalDecomposition(
    ...
    {
        eigen_assert(
            m_cpqr.m_isInitialized && "Decomposition is not initialized.");
        return Success;
    }
...
protected:
    ...
    void _check_solve_assertion(const Rhs& b) const
    {
        ...
        eigen_assert(
            ...
            "CompleteOrthogonalDecomposition::solve(): invalid number of rows "
    ...
    Dense2Dense>
{
    ...
    static void run(
        ...
        const internal::
            assign_op<typename DstXprType::Scalar, typename CodType::Scalar>&)
    {
        typedef Matrix<
