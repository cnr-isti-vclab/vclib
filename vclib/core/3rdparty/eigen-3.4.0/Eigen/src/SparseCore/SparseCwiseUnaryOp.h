...
template<typename UnaryOp, typename ArgType>
class unary_evaluator<CwiseUnaryOp<UnaryOp, ArgType>, IteratorBased>::
    InnerIterator :
...
public:
    EIGEN_STRONG_INLINE InnerIterator(
        ...
        Index                  outer) :
            Base(unaryOp.m_argImpl, outer),
            m_functor(unaryOp.m_functor)
    {
    }
...
template<typename ViewOp, typename ArgType>
class unary_evaluator<CwiseUnaryView<ViewOp, ArgType>, IteratorBased>::
    InnerIterator :
