...
struct binary_evaluator<
    ...
    IteratorBased,
    IteratorBased> : evaluator_base<CwiseBinaryOp<BinaryOp, Lhs, Rhs>>
{
protected:
...
public:
    ...
    public:
        EIGEN_STRONG_INLINE InnerIterator(
            ...
            Index                   outer) :
                m_lhsIter(aEval.m_lhsImpl, outer),
                m_rhsEval(aEval.m_rhsImpl), m_functor(aEval.m_functor),
                m_value(0), m_id(-1),
...
public:
    ...
    {
        return (std::min)(
            m_lhsImpl.nonZerosEstimate(), m_rhsImpl.nonZerosEstimate());
    }
