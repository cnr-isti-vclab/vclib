                ...
                ProductType>>
{
        ...
        const Scalar& alpha)
    {
        typedef typename nested_eval<
            Lhs,
            ((Rhs::Flags & RowMajorBit) == 0) ? 1 :
                                                Rhs::ColsAtCompileTime>::type
            LhsNested;
        typedef typename nested_eval<
            Rhs,
            ((Lhs::Flags & RowMajorBit) == 0) ? 1 : Dynamic>::type RhsNested;
                ...
                ProductType>>
{
        ...
        const Scalar& alpha)
    {
        typedef typename nested_eval<
            Lhs,
            ((Rhs::Flags & RowMajorBit) == 0) ? Dynamic : 1>::type LhsNested;
        typedef typename nested_eval<
            Rhs,
...
public:
    ...
    sparse_dense_outer_product_evaluator(
        ...
        const ActualRhs& rhs) :
            m_lhs(lhs),
            m_lhsXprImpl(m_lhs), m_rhsXprImpl(rhs)
    {
