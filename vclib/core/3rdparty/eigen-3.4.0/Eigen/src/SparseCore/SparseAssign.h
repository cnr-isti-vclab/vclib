...
struct Assignment<DstXprType, SrcXprType, Functor, Sparse2Dense, Weak>
{
    static void run(DstXprType& dst, const SrcXprType& src, const Functor& func)
    {
        ...
        const Index outerEvaluationSize =
            (internal::evaluator<SrcXprType>::Flags & RowMajorBit) ?
                src.rows() :
                src.cols();
        for (Index j = 0; j < outerEvaluationSize; ++j)
    ...
    static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
        ...
        run(DstXprType& dst,
            const CwiseBinaryOp<
                ...
                const Rhs>& src,
            const internal::
                assign_op<typename DstXprType::Scalar, Scalar>& /*func*/)
    {
...
struct Assignment<DstXprType, SrcXprType, Functor, Diagonal2Sparse>
{
    ...
    static void run(
        SparseMatrix<Scalar, Options, StorageIndex>& dst,
        const SrcXprType&                            src,
    ...
    static void run(
        SparseMatrixBase<DstDerived>& dst,
        const SrcXprType&             src,
        const internal::assign_op<
            typename DstXprType::Scalar,
            typename SrcXprType::Scalar>& /*func*/)
