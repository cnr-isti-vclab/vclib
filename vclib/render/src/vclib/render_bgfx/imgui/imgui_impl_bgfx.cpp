...
#include <vclib/render_bgfx/imgui/vs_ocornut_imgui.bin.h>
#include <vclib/render_bgfx/imgui/fs_ocornut_imgui.bin.h>
#include <vclib/render_bgfx/imgui/vs_imgui_image.bin.h>
#include <vclib/render_bgfx/imgui/fs_imgui_image.bin.h>

#include <vclib/render_bgfx/imgui/roboto_regular.ttf.h>
#include <vclib/render_bgfx/imgui/robotomono_regular.ttf.h>
#include <vclib/render_bgfx/imgui/icons_kenney.ttf.h>
#include <vclib/render_bgfx/imgui/icons_font_awesome.ttf.h>
...
// 	}
	...
	void beginFrameAlt(bgfx::ViewId _viewId)
	{
		m_viewId = _viewId;
	}
...
void ImGui_ImplBgfx_NewFrame(bgfx::ViewId viewId)
{
	s_ctx.beginFrameAlt(viewId);
}
