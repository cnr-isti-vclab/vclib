...
#include <vclib/bgfx/text/font/text_buffer_manager.h>

#include <vclib/bgfx/text/font/utf8.h>
#include <vclib/bgfx/text/font/cube_atlas.h>
...
void TextBufferManager::submitTextBuffer(TextBufferHandle _handle, bgfx::ViewId _id, int32_t _depth)
{
	...
	case FONT_TYPE_ALPHA:
        program = progMan.getProgram<vcl::VertFragProgram::FONT_BASIC>();
		bgfx::setState(0
	...
	{
        program = progMan.getProgram<vcl::VertFragProgram::FONT_DISTANCE_FIELD>();
		bgfx::setState(0
			| BGFX_STATE_WRITE_RGB
			| BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_SRC_ALPHA, BGFX_STATE_BLEND_INV_SRC_ALPHA)
			);
	...
	case FONT_TYPE_DISTANCE_SUBPIXEL:
        program = progMan.getProgram<vcl::VertFragProgram::FONT_DISTANCE_FIELD_SUBPIXEL>();
		bgfx::setState(0
			| BGFX_STATE_WRITE_RGB
	...
	{
        program = progMan.getProgram<vcl::VertFragProgram::FONT_DISTANCE_FIELD_OUTLINE>();
		bgfx::setState(0
			| BGFX_STATE_WRITE_RGB
			| BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_SRC_ALPHA, BGFX_STATE_BLEND_INV_SRC_ALPHA)
			);
	...
	{
        program = progMan.getProgram<vcl::VertFragProgram::FONT_DISTANCE_FIELD_OUTLINE_IMAGE>();
		bgfx::setState(0
			| BGFX_STATE_WRITE_RGB
			| BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_SRC_ALPHA, BGFX_STATE_BLEND_INV_SRC_ALPHA)
			);
	...
	{
        program = progMan.getProgram<vcl::VertFragProgram::FONT_DISTANCE_FIELD_DROP_SHADOW>();
		bgfx::setState(0
			| BGFX_STATE_WRITE_RGB
			| BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_SRC_ALPHA, BGFX_STATE_BLEND_INV_SRC_ALPHA)
			);
	...
	{
        program = progMan.getProgram<vcl::VertFragProgram::FONT_DISTANCE_FIELD_DROP_SHADOW_IMAGE>();
		bgfx::setState(0
			| BGFX_STATE_WRITE_RGB
			| BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_SRC_ALPHA, BGFX_STATE_BLEND_INV_SRC_ALPHA)
			);
	...
	{
        program = progMan.getProgram<vcl::VertFragProgram::FONT_DISTANCE_FIELD_OUTLINE_DROP_SHADOW_IMAGE>();
		bgfx::setState(0
			| BGFX_STATE_WRITE_RGB
			| BGFX_STATE_BLEND_FUNC(BGFX_STATE_BLEND_SRC_ALPHA, BGFX_STATE_BLEND_INV_SRC_ALPHA)
			);
