...
namespace vcl::lines {
    ...
    TextureBasedLines::TextureBasedLines(const TextureBasedLines& other) : DrawableLines(other) {
    ...
    TextureBasedLines::TextureBasedLines(TextureBasedLines&& other) : DrawableLines(other) {
        swap(other);
    }
