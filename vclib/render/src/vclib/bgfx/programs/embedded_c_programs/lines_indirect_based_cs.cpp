...
#include <vclib/bgfx/programs/embedded_c_programs/lines_indirect_based_cs.h>
...
bgfx::EmbeddedShader::Data vcl::ComputeLoader<ComputeProgram::LINES_INDIRECT_BASED_CS>::
