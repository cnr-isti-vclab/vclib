...
#include <vclib/bgfx/programs/embedded_c_programs/polylines_texture_based_cs.h>
...
bgfx::EmbeddedShader::Data vcl::ComputeLoader<ComputeProgram::POLYLINES_TEXTURE_BASED_CS>::
