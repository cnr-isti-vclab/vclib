    ...
    computeShader(bgfx::RendererType::Enum type)
{
    ...
    case bgfx::RendererType::OpenGLES:
        return {
            type,
            cs_cubemap_mipmap_gen_essl,
            sizeof(cs_cubemap_mipmap_gen_essl)};
    case bgfx::RendererType::OpenGL:
        return {
            type, cs_cubemap_mipmap_gen_400, sizeof(cs_cubemap_mipmap_gen_400)};
    case bgfx::RendererType::Vulkan:
        return {
            type, cs_cubemap_mipmap_gen_spv, sizeof(cs_cubemap_mipmap_gen_spv)};
#ifdef _WIN32
    case bgfx::RendererType::Direct3D11:
        return {
            type,
            cs_cubemap_mipmap_gen_dx11,
            sizeof(cs_cubemap_mipmap_gen_dx11)};
    case bgfx::RendererType::Direct3D12:
#endif
#ifdef __APPLE__
    case bgfx::RendererType::Metal:
        return {
            type, cs_cubemap_mipmap_gen_mtl, sizeof(cs_cubemap_mipmap_gen_mtl)};
#endif
