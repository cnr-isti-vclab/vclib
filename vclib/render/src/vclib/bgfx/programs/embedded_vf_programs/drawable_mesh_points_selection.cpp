...
#include <vclib/bgfx/programs/embedded_vf_programs/drawable_mesh_points_selection.h>

#include <vclib/bgfx/programs/macros.h>

// clang-format off
#define COMMON_PATH vclib/shaders/drawable/drawable_mesh/points_selection
// clang-format on
#define VS_NAME vs_points_selection
#define FS_NAME fs_points_selection
...
bgfx::EmbeddedShader::Data VertFragLoader<
    VertFragProgram::DRAWABLE_MESH_POINTS_SELECTION>::vertexShader(bgfx::RendererType::Enum type)
{
    switch (type) {
...
bgfx::EmbeddedShader::Data VertFragLoader<VertFragProgram::DRAWABLE_MESH_POINTS_SELECTION>::
