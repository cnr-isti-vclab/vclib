...
#include <vclib/bgfx/programs/embedded_vf_programs/lines_cpu_generated_vsfs.h>
...
bgfx::EmbeddedShader::Data vcl::VertFragLoader<VertFragProgram::LINES_CPU_GENERATED_VSFS>::
