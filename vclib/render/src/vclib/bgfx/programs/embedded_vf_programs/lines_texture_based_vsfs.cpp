...
#include <vclib/bgfx/programs/embedded_vf_programs/lines_texture_based_vsfs.h>
...
bgfx::EmbeddedShader::Data vcl::VertFragLoader<VertFragProgram::LINES_TEXTURE_BASED_VSFS>::
