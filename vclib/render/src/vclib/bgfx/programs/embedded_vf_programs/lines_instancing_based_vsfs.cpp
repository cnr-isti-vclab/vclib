...
#include <vclib/bgfx/programs/embedded_vf_programs/lines_instancing_based_vsfs.h>
...
bgfx::EmbeddedShader::Data vcl::VertFragLoader<VertFragProgram::LINES_INSTANCING_BASED_VSFS>::
