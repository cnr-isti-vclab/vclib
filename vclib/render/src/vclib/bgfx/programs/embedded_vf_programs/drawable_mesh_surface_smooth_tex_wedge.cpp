...
#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_smooth_tex_wedge.sc.glsl.bin.h>

#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_smooth_tex_wedge.sc.essl.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.essl.bin.h>

#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_smooth_tex_wedge.sc.spv.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.spv.bin.h>
#ifdef _WIN32
#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_smooth_tex_wedge.sc.dx11.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.dx11.bin.h>
#endif //  defined(_WIN32)
#ifdef __APPLE__
#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_smooth_tex_wedge.sc.mtl.bin.h>
    ...
    fragmentShader(bgfx::RendererType::Enum type)
{
    switch (type) {
    case bgfx::RendererType::OpenGLES:
        return {type, fs_surface_smooth_tex_wedge_essl, sizeof(fs_surface_smooth_tex_wedge_essl)};
    case bgfx::RendererType::OpenGL:
        return {type, fs_surface_smooth_tex_wedge_glsl, sizeof(fs_surface_smooth_tex_wedge_glsl)};
    case bgfx::RendererType::Vulkan:
        return {type, fs_surface_smooth_tex_wedge_spv, sizeof(fs_surface_smooth_tex_wedge_spv)};
#ifdef _WIN32
    case bgfx::RendererType::Direct3D11:
        return {type, fs_surface_smooth_tex_wedge_dx11, sizeof(fs_surface_smooth_tex_wedge_dx11)};
    case bgfx::RendererType::Direct3D12:
#endif
#ifdef __APPLE__
    case bgfx::RendererType::Metal:
        return {type, fs_surface_smooth_tex_wedge_mtl, sizeof(fs_surface_smooth_tex_wedge_mtl)};
#endif
    default: return {type, nullptr, 0};
    }
}
