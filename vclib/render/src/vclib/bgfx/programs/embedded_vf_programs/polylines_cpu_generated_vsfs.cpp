...
#include <vclib/bgfx/programs/embedded_vf_programs/polylines_cpu_generated_vsfs.h>
...
bgfx::EmbeddedShader::Data vcl::VertFragLoader<VertFragProgram::POLYLINES_CPU_GENERATED_VSFS>::
