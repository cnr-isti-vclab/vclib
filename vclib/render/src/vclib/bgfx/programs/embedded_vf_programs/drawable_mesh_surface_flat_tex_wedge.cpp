...
#include <vclib/bgfx/programs/embedded_vf_programs/drawable_mesh_surface_flat_tex_wedge.h>

#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_flat_tex_wedge.sc.glsl.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.glsl.bin.h>

#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_flat_tex_wedge.sc.essl.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.essl.bin.h>

#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_flat_tex_wedge.sc.spv.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.spv.bin.h>
#ifdef _WIN32
#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_flat_tex_wedge.sc.dx11.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.dx11.bin.h>
#endif //  defined(_WIN32)
#ifdef __APPLE__
#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_flat_tex_wedge.sc.mtl.bin.h>
...
bgfx::EmbeddedShader::Data VertFragLoader<
    VertFragProgram::DRAWABLE_MESH_SURFACE_FLAT_TEX_WEDGE>::
