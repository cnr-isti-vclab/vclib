...
#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_flat_color_face.sc.glsl.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.glsl.bin.h>

#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_flat_color_face.sc.essl.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.essl.bin.h>

#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_flat_color_face.sc.spv.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.spv.bin.h>
#ifdef _WIN32
#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_flat_color_face.sc.dx11.bin.h>
#include <vclib/shaders/drawable/drawable_mesh/surface/vs_surface.sc.dx11.bin.h>
#endif //  defined(_WIN32)
#ifdef __APPLE__
#include <vclib/shaders/drawable/drawable_mesh/surface/fs_surface_flat_color_face.sc.mtl.bin.h>
    ...
    fragmentShader(bgfx::RendererType::Enum type)
{
    ...
    case bgfx::RendererType::OpenGLES:
        return {
            type,
            fs_surface_flat_color_face_essl,
            sizeof(fs_surface_flat_color_face_essl)};
    case bgfx::RendererType::OpenGL:
        return {
            type,
            fs_surface_flat_color_face_glsl,
            sizeof(fs_surface_flat_color_face_glsl)};
    case bgfx::RendererType::Vulkan:
        return {
            type,
            fs_surface_flat_color_face_spv,
            sizeof(fs_surface_flat_color_face_spv)};
#ifdef _WIN32
    case bgfx::RendererType::Direct3D11:
        return {
            type,
            fs_surface_flat_color_face_dx11,
            sizeof(fs_surface_flat_color_face_dx11)};
    case bgfx::RendererType::Direct3D12:
#endif
#ifdef __APPLE__
    case bgfx::RendererType::Metal:
        return {
            type,
            fs_surface_flat_color_face_mtl,
            sizeof(fs_surface_flat_color_face_mtl)};
#endif
    default: return {type, nullptr, 0};
    }
}
