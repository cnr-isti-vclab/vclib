...
bgfx::EmbeddedShader::Data VertFragLoader<
    VertFragProgram::DRAWABLE_MESH_WIREFRAME_ID>::
    vertexShader(bgfx::RendererType::Enum type)
{
    switch (type) {
    case bgfx::RendererType::OpenGLES:
        return {type, vs_wireframe_id_essl, sizeof(vs_wireframe_id_essl)};
    case bgfx::RendererType::OpenGL:
        return {type, vs_wireframe_id_glsl, sizeof(vs_wireframe_id_glsl)};
    case bgfx::RendererType::Vulkan:
        return {type, vs_wireframe_id_spv, sizeof(vs_wireframe_id_spv)};
#ifdef _WIN32
    case bgfx::RendererType::Direct3D11:
        return {type, vs_wireframe_id_dx11, sizeof(vs_wireframe_id_dx11)};
    case bgfx::RendererType::Direct3D12:
#endif
#ifdef __APPLE__
    case bgfx::RendererType::Metal:
        return {type, vs_wireframe_id_mtl, sizeof(vs_wireframe_id_mtl)};
#endif
    ...
    fragmentShader(bgfx::RendererType::Enum type)
{
    switch (type) {
    case bgfx::RendererType::OpenGLES:
        return {type, fs_wireframe_id_essl, sizeof(fs_wireframe_id_essl)};
    case bgfx::RendererType::OpenGL:
        return {type, fs_wireframe_id_glsl, sizeof(fs_wireframe_id_glsl)};
    case bgfx::RendererType::Vulkan:
        return {type, fs_wireframe_id_spv, sizeof(fs_wireframe_id_spv)};
#ifdef _WIN32
    case bgfx::RendererType::Direct3D11:
        return {type, fs_wireframe_id_dx11, sizeof(fs_wireframe_id_dx11)};
    case bgfx::RendererType::Direct3D12:
#endif
#ifdef __APPLE__
    case bgfx::RendererType::Metal:
        return {type, fs_wireframe_id_mtl, sizeof(fs_wireframe_id_mtl)};
#endif
    default: return {type, nullptr, 0};
    }
}
