...
bgfx::EmbeddedShader::Data VertFragLoader<
    VertFragProgram::DRAWABLE_MESH_SURFACE_FLAT_COLOR_USER>::
    ...
    fragmentShader(bgfx::RendererType::Enum type)
{
    switch (type) {
    case bgfx::RendererType::OpenGLES:
        return {type, fs_surface_flat_color_user_essl, sizeof(fs_surface_flat_color_user_essl)};
    case bgfx::RendererType::OpenGL:
        return {type, fs_surface_flat_color_user_glsl, sizeof(fs_surface_flat_color_user_glsl)};
    case bgfx::RendererType::Vulkan:
        return {type, fs_surface_flat_color_user_spv, sizeof(fs_surface_flat_color_user_spv)};
#ifdef _WIN32
    case bgfx::RendererType::Direct3D11:
        return {type, fs_surface_flat_color_user_dx11, sizeof(fs_surface_flat_color_user_dx11)};
    case bgfx::RendererType::Direct3D12:
#endif
#ifdef __APPLE__
    case bgfx::RendererType::Metal:
        return {type, fs_surface_flat_color_user_mtl, sizeof(fs_surface_flat_color_user_mtl)};
#endif
    default: return {type, nullptr, 0};
    }
}
