...
#include <vclib/bgfx/programs/embedded_vf_programs/polylines_texture_based_vsfs.h>
...
bgfx::EmbeddedShader::Data vcl::VertFragLoader<VertFragProgram::POLYLINES_TEXTURE_BASED_VSFS>::
