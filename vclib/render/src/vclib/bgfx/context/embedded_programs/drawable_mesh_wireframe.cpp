...
#include <vclib/bgfx/context/embedded_programs/drawable_mesh_wireframe.h>
...
bgfx::EmbeddedShader::Data vcl::
    EmbeddedProgram<VclProgram::DRAWABLE_MESH_WIREFRAME>::vertexEmbeddedShader(
...
bgfx::EmbeddedShader::Data vcl::
    EmbeddedProgram<VclProgram::DRAWABLE_MESH_WIREFRAME>::fragmentEmbeddedShader(
        bgfx::RendererType::Enum type)
{
    switch (type) {
    case bgfx::RendererType::OpenGLES:
...
bgfx::EmbeddedShader::Data vcl::
    EmbeddedProgram<VclProgram::DRAWABLE_MESH_WIREFRAME>::computeEmbeddedShader(
        bgfx::RendererType::Enum type)
{
