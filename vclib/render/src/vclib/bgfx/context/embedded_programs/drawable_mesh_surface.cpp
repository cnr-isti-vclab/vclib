...
#include <vclib/bgfx/context/embedded_programs/drawable_mesh_surface.h>
...
bgfx::EmbeddedShader::Data vcl::
    EmbeddedProgram<VclProgram::DRAWABLE_MESH_SURFACE>::vertexEmbeddedShader(
...
bgfx::EmbeddedShader::Data vcl::
    EmbeddedProgram<VclProgram::DRAWABLE_MESH_SURFACE>::fragmentEmbeddedShader(
        bgfx::RendererType::Enum type)
{
    switch (type) {
    case bgfx::RendererType::OpenGLES:
...
bgfx::EmbeddedShader::Data vcl::
    EmbeddedProgram<VclProgram::DRAWABLE_MESH_SURFACE>::computeEmbeddedShader(
        bgfx::RendererType::Enum type)
{
