...
#include <vclib/bgfx/context/embedded_shaders/polylines_texture_based_joins_vsfs.h>

#include <shaders/drawable/drawable_lines/polylines/texture_based_polylines/fs_texture_based_polylines.sc.glsl.bin.h>
#include <shaders/drawable/drawable_lines/polylines/texture_based_polylines/vs_texture_based_joins.sc.glsl.bin.h>


#include <shaders/drawable/drawable_lines/polylines/texture_based_polylines/fs_texture_based_polylines.sc.essl.bin.h>
#include <shaders/drawable/drawable_lines/polylines/texture_based_polylines/vs_texture_based_joins.sc.essl.bin.h>


#include <shaders/drawable/drawable_lines/polylines/texture_based_polylines/fs_texture_based_polylines.sc.spv.bin.h>
#include <shaders/drawable/drawable_lines/polylines/texture_based_polylines/vs_texture_based_joins.sc.spv.bin.h>

#ifdef _WIN32
#include <shaders/drawable/drawable_lines/polylines/texture_based_polylines/fs_texture_based_polylines.sc.dx11.bin.h>
#include <shaders/drawable/drawable_lines/polylines/texture_based_polylines/vs_texture_based_joins.sc.dx11.bin.h>

#endif //  defined(_WIN32)
#ifdef __APPLE__
#include <shaders/drawable/drawable_lines/polylines/texture_based_polylines/fs_texture_based_polylines.sc.mtl.bin.h>
#include <shaders/drawable/drawable_lines/polylines/texture_based_polylines/vs_texture_based_joins.sc.mtl.bin.h>
#endif // __APPLE__

namespace vcl {

bgfx::EmbeddedShader::Data vcl::EmbeddedShader<VclProgram::POLYLINES_TEXTURE_BASED_JOINS_VSFS>::
    vertexEmbeddedShader(bgfx::RendererType::Enum type)
{
    switch (type) {
    case bgfx::RendererType::OpenGLES:
        return {type, vs_texture_based_joins_essl, sizeof(vs_texture_based_joins_essl)};
    case bgfx::RendererType::OpenGL:
        return {type, vs_texture_based_joins_glsl, sizeof(vs_texture_based_joins_glsl)};
    case bgfx::RendererType::Vulkan:
        return {type, vs_texture_based_joins_spv, sizeof(vs_texture_based_joins_spv)};
#ifdef _WIN32
    case bgfx::RendererType::Direct3D11:
        return {type, vs_texture_based_joins_dx11, sizeof(vs_texture_based_joins_dx11)};
    case bgfx::RendererType::Direct3D12:
#endif
#ifdef __APPLE__
    case bgfx::RendererType::Metal:
        return {type, vs_texture_based_joins_mtl, sizeof(vs_texture_based_joins_mtl)};
#endif
