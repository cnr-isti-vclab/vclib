...
#include <vclib/bgfx/context/embedded_shaders/drawable_mesh_edges.h>
...
bgfx::EmbeddedShader::Data vcl::
    EmbeddedShader<VclProgram::DRAWABLE_MESH_EDGES>::vertexEmbeddedShader(
...
bgfx::EmbeddedShader::Data vcl::
    EmbeddedShader<VclProgram::DRAWABLE_MESH_EDGES>::fragmentEmbeddedShader(
        bgfx::RendererType::Enum type)
{
    switch (type) {
    case bgfx::RendererType::OpenGLES:
...
bgfx::EmbeddedShader::Data vcl::
    EmbeddedShader<VclProgram::DRAWABLE_MESH_EDGES>::computeEmbeddedShader(
        bgfx::RendererType::Enum type)
{
