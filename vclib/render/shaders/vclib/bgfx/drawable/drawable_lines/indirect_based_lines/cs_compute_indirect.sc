...
BUFFER_WO(instanceDataBuffer,   vec4,  4);
...
void main()
{
    ...
    uint line_color   = lineColor(gl_WorkGroupID.x);
    ...
    instanceDataBuffer[(gl_WorkGroupID.x * 4) + 2]  = vec4(normal0.xyz, uintBitsToFloat(line_color));
