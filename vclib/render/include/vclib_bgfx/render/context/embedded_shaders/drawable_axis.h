...
#ifndef VCL_BGFX_RENDER_CONTEXT_EMBEDDED_SHADERS_DRAWABLE_AXIS_H
#define VCL_BGFX_RENDER_CONTEXT_EMBEDDED_SHADERS_DRAWABLE_AXIS_H
...
#endif // VCL_BGFX_RENDER_CONTEXT_EMBEDDED_SHADERS_DRAWABLE_AXIS_H
