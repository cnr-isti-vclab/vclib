...
#ifndef VCL_QT_GUI_UNDO_REDO_ACTIONS_RENAME_DRAWABLE_OBJECT_ACTION_H
#define VCL_QT_GUI_UNDO_REDO_ACTIONS_RENAME_DRAWABLE_OBJECT_ACTION_H
...
#endif // VCL_QT_GUI_UNDO_REDO_ACTIONS_RENAME_DRAWABLE_OBJECT_ACTION_H
