...
#ifndef VCL_BGFX_CONTEXT_EMBEDDED_PROGRAM_H
#define VCL_BGFX_CONTEXT_EMBEDDED_PROGRAM_H

#include <bgfx/embedded_shader.h>

namespace vcl {

enum class VclProgram
{
    DRAWABLE_AXIS,
...
template<VclProgram PROGRAM = VclProgram::COUNT>
...
#endif // VCL_BGFX_CONTEXT_EMBEDDED_PROGRAM_H
