...
#ifndef VCL_BINDINGS_MESH_COMPONENTS_WEDGE_TEX_COORDS_H
#define VCL_BINDINGS_MESH_COMPONENTS_WEDGE_TEX_COORDS_H
...
#endif // VCL_BINDINGS_MESH_COMPONENTS_WEDGE_TEX_COORDS_H
