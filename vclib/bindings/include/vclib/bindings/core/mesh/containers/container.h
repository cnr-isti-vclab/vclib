...
void addOptionalComponentFunctions(pybind11::class_<MeshType, Options...>& c,
...
void initContainer(pybind11::class_<MeshType, Options...>& c,
    const std::string&          name,
...
#endif // VCL_BINDINGS_CORE_MESH_CONTAINERS_CONTAINER_H
